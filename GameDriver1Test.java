...
public class GameDriver1Test
{
    ...
    public static void main(String[] args)
    {
        ...
        battleBugs.add(new Gary(2,3,0, "Gary", null));
		battleBugs.add(new BBExample(2,2,1, "Magenta bug", Color.MAGENTA));
		battleBugs.add(new BBExample(2,3,0, "Cyan bug", Color.CYAN));
		battleBugs.add(new Peter(3,2,0, "Peter", null));
